...
Wake Word | this is the word is spoken to let your Alexa device you are speaking to it. Alexa has a small subset of wake words that can be used: Alexa, Echo, Computer, Amazon. 
