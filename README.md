...
Most applications today require some kind of backend that stores and arranges data. For this activity, we will be using Lambda as our backend hosted service. 
